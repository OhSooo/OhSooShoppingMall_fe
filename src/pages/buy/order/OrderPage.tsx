...
import type { CartItem } from '../../../services/cart/normalizeCart';
...
export default function OrderPage() {
  ...
  const baseAmount = state?.originalTotalPrice ?? 0;
  ...
  const totalAmount = Math.max(0, baseAmount - couponDiscount - mileageDiscount);
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '12px', padding: '0 0 4px' }}>
          ...
          <div>
            ...
            <div style={{ padding: '12px 24px' }}>
              {orderItems.length === 0 ? (
                ...
                >
                  주문 상품이 비어있습니다. 장바구니에서 상품을 선택해 주세요.
                </div>
              ) : (
                  ...
                  {orderItems.map((item) => (
                    ...
                    >
                      ...
                      <div style={{ flex: 1 }}>
                        ...
                        <p style={{ margin: 0, fontSize: '12px', color: 'var(--color-gray-4)' }}>
                        ...
                        <p style={{ margin: '2px 0 0', fontSize: '12px', color: 'var(--color-gray-4)' }}>
                          X {item.quantity}
                        </p>
                      </div>
                    ...
                    {COUPONS.map((c, i) => (
                      <label
                        ...
                        style={{
                          ...
                          backgroundColor: selectedCoupon === c.id ? 'var(--color-point-sub)' : 'var(--color-white)',
                        }}
                      >
                        <input
                          type="radio"
          ...
          <div style={{ padding: '16px 24px 20px' }}>
            <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '10px' }}>
              ...
              <span style={{ fontSize: '14px', color: 'var(--color-black)' }}>{baseAmount.toLocaleString()}원</span>
            </div>
            <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '10px' }}>
              ...
              <span
                style={{
                  fontSize: '14px',
                  color: couponDiscount > 0 ? 'var(--color-point-main)' : 'var(--color-gray-4)',
                }}
              >
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '16px' }}>
              ...
              <span
                style={{
                  fontSize: '14px',
                  color: mileageDiscount > 0 ? 'var(--color-point-main)' : 'var(--color-gray-4)',
                }}
              >
            ...
            >
              ...
              <Button
                variant="primary"
                disabled={ordering || orderItems.length === 0}
                onClick={async () => {
